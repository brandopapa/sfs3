...
if($_POST['grad_year']) {
	...
	$data="<tr align='center' bgcolor='#ffdddd'><td>班級</td><td>座號</td><td>學號</td><td>姓名</td><td>類別</td><td>證書號</td><td>畢業成績</td><td>入學學校</td><td>升學學校</td><td>戶籍地址</td><td>戶籍電話</td><td>聯絡地址</td><td>聯絡電話</td>";
	while(!$rs->EOF) {
		...
		$data.="<tr align='center' bgcolor='$bgcolor'><td>$class_id</td><td>$class_num</td><td>{$rs->fields['stud_id']}</td><td>{$rs->fields['stud_name']}</td><td>$nature</td>
