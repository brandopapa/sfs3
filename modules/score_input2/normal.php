<?php
// $Id: normal.php 6993 2012-11-02 03:51:40Z hami $
/*引入學務系統設定檔*/
include "config.php";
include "./module-upgrade.php";
require_once "../../include2/sfs_case_score.php";
//引入函數
include "./my_fun.php";
...
//if(empty($sel_year))$sel_year = curr_year(); //目前學年 update 20150831
//if(empty($sel_seme))$sel_seme = curr_seme(); //目前學期 update 20150831
...
//成績表名稱
//$nor_score="nor_score_".curr_year()."_".curr_seme(); update 20150831
//$score_semester="score_semester_".curr_year()."_".curr_seme(); update 20150831
...
//取得正確任教課程
$course_arr_all=get_teacher_course($sel_year,$sel_seme,$teacher_sn,$is_allow);
...
$smarty->assign("year_seme_sel",$year_seme_menu);
...
//exit;	
	...
	$smarty->assign("module_name","平常成績管理");
